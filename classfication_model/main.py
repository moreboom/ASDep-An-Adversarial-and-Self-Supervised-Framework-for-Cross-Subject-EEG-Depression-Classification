...
# --------------------------------------------------- I/O --------------------------------------------------------------
parser.add_argument('--data_dir', default='Dataset/Crowdsource', choices={'Dataset/MDD2'}, help='Data directory')
...
parser.add_argument('--lr', type=float, default=(1e-5)*4, help='learning rate')#1e-4
parser.add_argument('--dropout', type=float, default=0.15, help='Dropout regularization ratio')#0.1
